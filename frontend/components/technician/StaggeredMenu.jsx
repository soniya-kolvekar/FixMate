  ...
  return (
    ...
    >
      <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
        {(() => {
          const raw = colors && colors.length ? colors.slice(0, 4) : ['#134074', '#13315C', '#0B2545'];
          let arr = [...raw];
          if (arr.length >= 3) {
      ...
      <button
        ref={toggleBtnRef}
        className="sm-toggle font-heading"
        ...
        <div className="sm-panel-inner">
            ...
            {items && items.length ? (
              items.map((it, idx) => (
                <li className="sm-panel-itemWrap" key={it.label + idx}>
                  ...
                  >
                    <span className="sm-panel-itemLabel font-heading">{it.label}</span>
                  </a>
                </li>
              ))
            ) : (
          ...
          {displaySocials && socialItems && socialItems.length > 0 && (
            <div className="sm-socials" aria-label="Social links">
              <h3 className="sm-socials-title font-heading">Quick Actions</h3>
                ...
                {socialItems.map((s, i) => (
                  <li key={s.label + i} className="sm-socials-item">
                    <a 
                      ...
                      className="sm-socials-link font-medium"
                    >
                      {s.label}
                    </a>
                  </li>
